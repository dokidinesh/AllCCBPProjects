...
class App extends Component {
  ...
  renderVisitedCountries = () => {
    ...
    const numberOfVisitedCountries = visitedCountriesList.length
    ...
    return <p className="empty-container">No Countries Visited Yet</p>
  }
